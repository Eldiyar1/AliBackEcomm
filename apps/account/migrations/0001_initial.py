        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "postcode",
                    models.CharField(
                        blank=True, max_length=12, verbose_name="Почтовый индекс"
                    ),
                ),
                (
                    "address_line_1",
                    models.CharField(
                        blank=True, max_length=150, verbose_name="Адрес, строка 1"
                    ),
                ),
                (
                    "address_line_2",
                    models.CharField(
                        blank=True, max_length=150, verbose_name="Адрес, строка 2"
                    ),
                ),
                (
                    "town_city",
                ...
                (
                    ...
                    models.CharField(
                        max_length=255, verbose_name="Инструкции по доставке"
                    ),
                ),
                (
                    "created_at",
